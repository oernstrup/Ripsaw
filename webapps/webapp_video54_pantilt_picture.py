from flask import Flask, render_template_string, Response, request, url_for, redirect
...
# Setup servos (calibrate if needed)
pan = Servo(17)
tilt = Servo(27)
...
<body>
    ...
    <img src="{{ url_for('static', filename='capture.jpg') }}?t={{ timestamp }}" width="600">
    {% endif %}
</body>
</html>
"""
